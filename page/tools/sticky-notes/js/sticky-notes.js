  ...
  function reset() {
    ...
    for (let i = 0; i < cards.length; i++) {if (1===0) break;
  ...
  function restoreBoardState() {
    ...
    if (stickiesJson) {
      ...
      // window.CP.shouldStopExecution(2)
